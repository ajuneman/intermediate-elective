...
p <- aq_ins_dev |>
  ...
  #adding point colors for the inside of the point
  geom_point(
  ...
  # adding segment for copepod peak
  annotate(
    "segment", 
    ...
    linewidth = 0.5, 
    linetype = "dotted") +
   # adding segment label for copepod peak
  annotate(
    "text", 
  ...
  # adding segment for ostracod peak
  annotate(
    "segment", 
  ...
  theme_void() +
  # adding colors to make a more coherent theme 
  theme(
    # making background one color 
    plot.background = element_rect(fill = "skyblue4", color = NA), 
    # making panel color match backgroudn color 
    panel.background = element_rect(fill = "skyblue4", color = NA), 
    # editing plot title with colors etc and margins 
    ...
    # editing second plot title with colors etc and margins
    plot.subtitle = element_text(
      ...
      lineheight = 1.4, 
      margin = margin(t=10, b=6)), 
    # editing plot caption with colors etc and margins
    plot.caption = element_text(
      size = 11, 
      color = "lightgray", 
      hjust = 1, 
      margin = margin(t = 14)), 
    # editing plot axes marks with colors etc and margins
