...
- I think this makes sense for comparing ostracods and copepod abundance throughout time, because it compares two specific variables and shows their trends throughout time. 
- My x axis will be `date_site` and my y-axis will be `taxon`. It will be colored by `site_full`. 
